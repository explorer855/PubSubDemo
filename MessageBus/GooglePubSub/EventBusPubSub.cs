...
namespace GooglePubSub
{
        ...
        //: IEventBus
    {
        ...
        public EventBusPubSub(IPubSubPersisterConnection serviceBusPersisterConnection,
            ILogger<EventBusPubSub> logger, IEventBusSubscriptionsManager subsManager, string subscriptionClientName,
